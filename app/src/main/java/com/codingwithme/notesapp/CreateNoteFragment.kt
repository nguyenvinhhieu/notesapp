    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnOk.setOnClickListener {
            if (etWebLink.text.toString().trim().isNotEmpty()){
                ...
                Toast.makeText(requireContext(),"Url là bắt buộc",Toast.LENGTH_SHORT).show()
            }
        }
    ...
    private fun saveNote(){
        ...
        when {
            etNoteTitle.text.isNullOrEmpty() -> {
                Toast.makeText(context,"Lưu ý Tiêu đề là bắt buộc",Toast.LENGTH_SHORT).show()
            }
            etNoteSubTitle.text.isNullOrEmpty() -> {

                Toast.makeText(context,"Lưu ý Tiêu đề phụ là bắt buộc",Toast.LENGTH_SHORT).show()
            }
            etNoteDesc.text.isNullOrEmpty() -> {

                Toast.makeText(context,"Lưu ý Mô tả là bắt buộc",Toast.LENGTH_SHORT).show()
            }
            else -> {
